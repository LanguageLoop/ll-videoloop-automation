    ...
    capabilities : [
        {
            ...
            deviceName: 'Selva\'s iPhone',
            platformVersion: '13.5.1',
            udid       : '4db8a674ef7895ad6d92f6a469b8e3ea576732a7',
            ...
            // The path to the app
             app: join(process.cwd(),'/VideoLoop.ipa'),
...
//exec('curl "https://li-test.languageloop.com.au/NativeAppBuilder/rest/Download/Ipa?AppKey=ee106a1d-dc64-4203-a338-3f03468e7daa" --output VideoLoop.ipa', function (error, stdOut, stdErr) {
    // do what you want!
   console.log("LS*****************************************************")
